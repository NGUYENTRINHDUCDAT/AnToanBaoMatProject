...
<div class="container_form">
    <form id="form_register" class="form-container" action="../customer?action=confirmSignatureEditOrder" method="post">
        ...
        <p style="color: red; text-align: center">Vui lòng tạo chữ kí với văn bản dưới đây để xác nhận chỉnh sửa đơn hàng</p>
