    ...
    <form class="form-container" action="../customer?action=confirmEditOrder" method="post">
        <table class="table">
            ...
            <tr>
                ...
                <td> ${orderDetail.customer.fullName}
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <c:forEach var="p" items="${orderDetail.orderItems}">
                        <div id="order-item-${p.id}" style="display: flex; align-items: center; margin-bottom: 10px;">
                            ...
                            <!-- Tên sản phẩm -->
                            <b class="product-name" style="margin-right: 10px; font-size: 12px;">${p.product.name}</b>
                            ...
                            <div class="btn-group" style="margin-left: 10px;">
                                ...
                                <button style="height: 40px;" type="button" class="btn-plus btn btn-info btn-sm" value="${p.id}" data-orderitem-id="${p.id}">
                                    <i class="bi bi-plus icon"></i>
                                </button>
                            </div>

                            <!-- Nút xóa -->
                            <button style="background: red"  style="height: 40px; margin-left: 10px;" type="button" class="btn-remove btn btn-danger btn-sm" value="${p.id}" data-orderitem-id="${p.id}">
            ...
            <tr>
                ...
                <td> <b id="price-product"><fmt:formatNumber value="${orderDetail.priceProduct()}" type="currency"
            ...
            <tr>
                ...
                <td id="totalPrice" style="font-weight: bolder" > <b id="price-total"> <fmt:formatNumber value="${orderDetail.total}" type="currency"
                                                                                   currencyCode="VND" minFractionDigits="0" /> </b> </td>
            </tr>
            <tr>
        ...
        <button type="submit" class="btn btn-primary" style="width: 100%;"> Xác nhận chỉnh sửa đơn hàng  </button>
