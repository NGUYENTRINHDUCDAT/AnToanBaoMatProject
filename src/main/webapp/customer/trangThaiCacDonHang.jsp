...
<div class="container">
    ...
    <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
        ...
        <li class="nav-item" role="presentation">
            <a class="a" href="../customer?action=getOrderStatus&status=6"><button class="nav-link <%= (status == 6) ? "active" : "" %>" id="edited-order" data-bs-toggle="pill" type="button" role="tab" aria-controls="cancelled-orders" aria-selected="false"> Đã bị chỉnh sửa </button></a>
        </li>
        <li class="nav-item" role="presentation">
            <a class="a" href="../customer?action=getOrderStatus&status=7"><button class="nav-link <%= (status == 7) ? "active" : "" %>" id="refund-order" data-bs-toggle="pill" type="button" role="tab" aria-controls="cancelled-orders" aria-selected="false"> Y/c hoàn tiền </button></a>
        </li>
    </ul>
    <h4 class="text">
        <span> ${emtyOrder} </span>
