...
<div class="container_form">
    ...
    <form class="form-container" action="" method="post" style="margin-top: 60px">
        <h1 class="text-center text-success">
            Xác Nhận Chỉnh Sửa Đơn Hàng <a href="#" class="logo-link"> <img
                style="width: 80px; height: 80px" src="/assets/images/rau.png" alt="Logo"
                class="logo-image">
        </a>
        </h1>

        <b> Chúc mừng bạn đã chỉnh sửa đơn hàng thành công<a class="link-warning" href="<c:url value='../trangChu.jsp'/>"> Quay về trang chủ ! </a> </b>
