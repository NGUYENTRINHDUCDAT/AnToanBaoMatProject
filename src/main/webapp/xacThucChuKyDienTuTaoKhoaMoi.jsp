...
<div class="container_form">
    <form id="form_register" class="form-container" action="../customer?action=confirmSignatureCreateNewKey" method="post">
        ...
        <p style="color: red; text-align: center">Vui lòng tạo chữ kí với văn bản dưới đây để xác nhận chính chủ</p>
...
<%--        </div>--%>
        <div class="mb-3">
            <label for="hash" class="form-label">Mã Hash:
            </label>
