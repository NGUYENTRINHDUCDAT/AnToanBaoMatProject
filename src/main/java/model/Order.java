...
public class Order implements IModel {
    ...
    public Order(int id, Customer customer, String toName, double total, Timestamp date, String numberPhone, String from_address, String to_address, double deliveryFee, Timestamp deliveryDate, String note, PaymentMethod paymentMethod, OrderStatus status, Voucher voucher, List<OrderItem> orderItems, String beforeData, String hash) {
        this.id = id;
        this.customer = customer;
        this.toName = toName;
        this.total = total;
